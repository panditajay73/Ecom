...
/**
 * Servlet implementation class EditProductModal
 */
@WebServlet("/EditProductModal")
public class EditProductModal extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			rs.next();
			out.append("<form action=\"EditProduct\" method=\"get\" style=\"max-height:400px; overflow-y:scroll\">");
