...
<div class="container">
	<h2 style="font-family: 'Merriweather', serif;">Search results for "<%=request.getParameter("query") %>"</h2>
</div>
<br><br>
<%!
...
PreparedStatement statement = con.prepareStatement("select * from products where productDescription like '%" + request.getParameter("query") + "%'");
